...
import { Search, Filter, UserPlus, Check, Clock, MapPin, Building, Map } from 'lucide-react';
...
const Members: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Search & Filters */}
      <div className="sticky top-0 z-10 bg-white border-b border-blue-200 p-3">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {members.map((member) => (
              <div key={member.id} className="bg-white rounded-xl p-4 border border-blue-200 hover:border-blue-400 transition-colors hover:shadow-sm">
                <div className="flex flex-col">
                  {/* Top Row: Avatar + Name + Connect Button */}
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
