    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="relative">
        ...
        <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2">
          <div className="relative">
            <div className="w-32 h-32 bg-gray-100 rounded-full border-4 border-white shadow-2xl overflow-hidden">
              {profile.avatar_url ? (
                <img
...
const PostGrid = ({ posts, isOwner, onDelete }: any) => {
  ...
  return (
    <div className="space-y-6">
      {posts.map((post: any) => (
        <div key={post.id} className="bg-white rounded-2xl border overflow-hidden shadow-sm">
          {/* Post Header */}
          <div className="p-4">
          ...
          {post.media_urls && post.media_urls.length > 0 && (
            <div className={`px-4 pb-4 ${
              ...
              post.media_urls.length === 2 ? 'grid grid-cols-2 gap-2' :
              post.media_urls.length === 3 ? 'grid grid-cols-2 gap-2' :
          ...
          {/* Post Stats removed - just showing post content and media */}
        </div>
      ))}
    </div>
  );
  ...
  if (listings.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">No listings to show.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      {listings.map((listing: any) => (
        <div key={listing.id} className="bg-white rounded-xl border p-4">
  ...
  if (businesses.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">No businesses to show.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      {businesses.map((business: any) => (
        <div key={business.id} className="bg-white rounded-xl border p-4">
          <div className="flex gap-4">
            <div className="w-20 h-20 bg-gray-200 rounded-lg overflow-hidden flex-shrink-0">
              {business.logo_url && (
                <img
  ...
  if (jobs.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">No jobs to show.</p>
      </div>
    );
  }
